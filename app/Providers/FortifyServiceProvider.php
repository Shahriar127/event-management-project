...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        // Bind a custom Fortify login response so we can redirect users after login
        $this->app->singleton(\Laravel\Fortify\Contracts\LoginResponse::class, \App\Http\Responses\LoginResponse::class);

        // Bind a custom Fortify register response to redirect to login after registration
